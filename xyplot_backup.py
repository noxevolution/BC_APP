...
##        for i in range(0,num_associations-1):
##            print "deleting" + str(i)
##            self.associations [i] [0].delete
        ...
        _association = self.associations [self.associationId - 1]

        
        _association [0].axis [0].combo.preselectFromIndex (209)
        _association [0].axis [1].combo.preselectFromIndex (209)
        _association [0].axis [2].combo.preselectFromIndex (209)
        _association [0].setAssociationNames (False)
        _association [1].associationChanged (_association, 0)
        #self.root.noLog = _previousLogState
